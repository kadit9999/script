--[[ 
    PREMIUM CLEAN WHITE KEY SYSTEM 2026 - AUTO SYNC & AUTO SAVE EDITION
    Cấu hình Script: HuyScript (Cập nhật Config_URL)
]]
...
local fetchedLink = "https://funlink.io/Pu_s2wc" -- Dự phòng
local fetchedKey = "vietnam76" -- Dự phòng
...
---------------------------------------------------------
-- HÀM KÍCH HOẠT SCRIPT CHÍNH CỦA BẠN
---------------------------------------------------------
...
---------------------------------------------------------
-- KHỞI TẠO GIAO DIỆN CHUẨN (TONE MÀU TRẮNG SANG TRỌNG)
---------------------------------------------------------
...
MainFrame.BackgroundColor3 = Color3.fromRGB(245, 246, 250) -- Nền trắng sáng
...
DropShadow.ImageColor3 = Color3.fromRGB(120, 120, 130) -- Bóng mờ xám hợp nền trắng
...
UIStroke.Color = Color3.fromRGB(220, 221, 230) -- Viền xám thanh lịch

local Title = Instance.new("TextLabel")
Title.Parent = MainFrame
Title.Text = "SECURE ACCESS"
Title.Font = Enum.Font.GothamBold
Title.TextColor3 = Color3.fromRGB(47, 53, 66) -- Chữ tối màu dễ đọc
Title.TextSize = 20
...
KeyInput.Text = ""
KeyInput.BackgroundColor3 = Color3.fromRGB(255, 255, 255) -- Ô nhập trắng tinh
KeyInput.BackgroundTransparency = 0
KeyInput.Position = UDim2.new(0.08, 0, 0.33, 0)
KeyInput.Size = UDim2.new(0.84, 0, 0, 45)
KeyInput.TextColor3 = Color3.fromRGB(47, 53, 66)
...
InputStroke.Color = Color3.fromRGB(255, 71, 87) -- Viền hồng/đỏ nổi bật
...
CopyBtn.TextSize = 12
CopyBtn.BackgroundColor3 = Color3.fromRGB(238, 239, 245) -- Nút phụ xám nhẹ
CopyBtn.TextColor3 = Color3.fromRGB(255, 71, 87)
...
SubmitBtn.BackgroundColor3 = Color3.fromRGB(255, 71, 87) -- Nút kích hoạt hồng/đỏ
...
PlayHover(CopyBtn, Color3.fromRGB(225, 226, 235), UDim2.new(0.86, 0, 0, 34), Color3.fromRGB(238, 239, 245), UDim2.new(0.84, 0, 0, 32))
PlayHover(SubmitBtn, Color3.fromRGB(255, 94, 108), UDim2.new(0.86, 0, 0, 42), Color3.fromRGB(255, 71, 87), UDim2.new(0.84, 0, 0, 40))
...
local function AdvancedNotify(msg, color)
    ...
    Text.Text = msg
    Text.TextColor3 = Color3.fromRGB(47, 53, 66)
...
CopyBtn.MouseButton1Click:Connect(function()
    if setclipboard then
        ...
        AdvancedNotify("Đã sao chép link get key mới nhất!", Color3.fromRGB(255, 71, 87))
    else
        AdvancedNotify("Executor không hỗ trợ sao chép nhanh!", Color3.fromRGB(255, 71, 87))
    end
    task.wait(2)
    CopyBtn.Text = "GET KEY LINK"
end)
...
SubmitBtn.MouseButton1Click:Connect(function()
    ...
    if userKey == fetchedKey then
        ...
        SubmitBtn.BackgroundColor3 = Color3.fromRGB(46, 213, 115) -- Thành công màu xanh lá
        SubmitBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
        ...
        SubmitBtn.BackgroundColor3 = Color3.fromRGB(255, 71, 87)
        AdvancedNotify("Mã khóa không chính xác hoặc đã hết hạn!", Color3.fromRGB(255, 71, 87))
        task.wait(2)
        SubmitBtn.Text = "ACTIVATE SCRIPT"
        SubmitBtn.BackgroundColor3 = Color3.fromRGB(255, 71, 87)
    end
